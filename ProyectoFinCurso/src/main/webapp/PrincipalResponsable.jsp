...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a onclick="irANuevoEmpleado()">Nuevo Empleado</a></li>
            <li><a onclick="irAModificarContrasegna()">Modificar Contraseña</a></li>
            <li><a onclick="irABajaEmpleado()">Baja de Empleado</a></li>
					...
					<div class="contenedor-perfil">
						...
						<div class="imagen-y-tabla">
							...
							<div id="tabla-container"></div>
        				 	...
        				 	function irANuevoEmpleado() {
        				 		window.location.href = "AltaEmpleado.jsp?id_empleado="+idEmpleado+"&mail="+email+"&id_cargo="+cargo;
        				        }
        				 	...
        				 	function irABajaEmpleado() {
        				 		window.location.href = "BajaEmpleado.jsp?id_empleado="+idEmpleado+"&mail="+email+"&id_cargo="+cargo;
        				        }
